This dataset is used for detecting credit card fraud. One significant property of this dataset is that it is highly imbalanced. The class 'fraud' is much less than the class 'not fraud'.
